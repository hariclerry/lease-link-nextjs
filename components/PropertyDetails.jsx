import { FaTimes, FaBed, FaBath, FaCheck, FaRulerCombined, FaMapMarker } from "react-icons/fa";
...
const PropertyDetails = ({property}) => {
    return ( 
        <main>
        <div
          className="bg-background-primary  p-6 rounded-lg shadow-md text-center md:text-left"
        >
          ...
          <div className="flex flex-col md:flex-row justify-around">
            ...
            >
              <div className="text-text-primary mr-2 font-bold">Nightly</div>
            ...
            <div
              className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0"
            >
              <div className="text-text-primary mr-2 font-bold">Weekly</div>
            ...
            <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
              <div className="text-text-primary mr-2 font-bold">Monthly</div>
        ...
        <div className="bg-background-primary  p-6 rounded-lg shadow-md mt-6">
